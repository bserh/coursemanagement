...
Clears the in-message cache used to speed up the instance.
...
Clears the in-message cache used to speed up the whole module.
This clears the static in-message cache as well as in-message cache used by instances.

Note that in edge cases, some instance's in-message cache might be skipped.
